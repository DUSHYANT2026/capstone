  ...
  const codeExamples = [
    {
      ...
      complexityDetails: {
        time: "O(n)",
        space: "O(1)",
        explanation: "Two passes through the array with constant space operations"
      },
...
print("Single numbers:", single_number(nums))`,
    ...
    },
    {
      ...
      complexityDetails: {
        time: "O(log n)",
        space: "O(1)",
        explanation: "Compares bits from both ends moving towards center"
      },
      cppcode: `#include <iostream>
using namespace std;
...
print(is_binary_palindrome(num))`,
    ...
    },
    {
      ...
      complexityDetails: {
        time: "O(log(min(a,b)))",
        space: "O(1)",
        explanation: "Each iteration reduces problem size logarithmically"
      },
      cppcode: `#include <iostream>
using namespace std;
...
print("GCD:", gcd(a, b))`,
    ...
    },
    {
      ...
      complexityDetails: {
        time: "O(log(min(a,b)))",
        space: "O(1)",
        explanation: "Relies on GCD calculation plus constant time operations"
      },
      cppcode: `#include <iostream>
#include <cmath>
using namespace std;
...
print("LCM:", lcm(a, b))`,
    ...
    },
    {
      ...
      complexityDetails: {
        time: "O(log n)",
        space: "O(1)",
        explanation: "Uses matrix exponentiation to reduce problem size exponentially"
      },
      cppcode: `#include <iostream>
using namespace std;
...
print("Fibonacci number:", fibonacci(n))`,
  ...
  return (
    ...
    >
      ...
      >
        MAANG Interview Practice Questions
      </h1>
